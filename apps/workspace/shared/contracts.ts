...
export const moduleCatalog = [
  ...
  { id:'finance', name:'Finance', status:'Partial', detail:'Versioned CSV source reports and exact comparisons. Document attachments, accounting, reconciliations, budgets and pay policies remain planned.' },
