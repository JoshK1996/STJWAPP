...
Current implementation work: recurring job staffing coverage, independent calendar-period job hours targets, visual range/filter controls, direct employee/job planning entry and reviewed spreadsheet/document schedule imports. Preserve saved-shift allowance/preclock semantics, individual editing, scope/session validation and exact evidence. See STAFF-PLANNING and ADR0012; STATUS/VALIDATION must record the actual release gates.
