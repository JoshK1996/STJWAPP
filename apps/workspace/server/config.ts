...
export function readConfig() {
  ...
  return {origin,production,staffDomain:process.env.STAFF_EMAIL_DOMAIN??'stjw.org',demo:process.env.DEMO_MODE!=='false',ownerEmail:process.env.OWNER_EMAIL??'owner@example.test'};
}
